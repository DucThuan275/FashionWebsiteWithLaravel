    ...
    <div class="container mx-auto px-4 py-8">
        <div class="container mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-600">Cập nhật thông tin sản phẩm</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div id="nameCounter" class="text-sm text-gray-500 mt-1"></div>
                            @error('name')
                        ...
                        <div>
                            ...
                            @if ($product->thumbnail)
                                <div class="mt-2">
                                    <img src="{{ asset('images/products/' . $product->thumbnail) }}"
                                        class="h-32 w-32 object-cover rounded-lg" alt="Current thumbnail">
                            ...
                            <div id="image-preview-container" class="hidden mt-3">
                                <img id="image-preview" class="h-32 w-32 object-cover rounded-lg" src="#"
                                    alt="Preview">
                                <p class="text-sm text-gray-500 mt-1">Hình ảnh mới</p>
                            </div>
                            @error('thumbnail')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-class="mt-1
                                block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $product->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('content', $product->content) }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
