<x-layout-admin>
    ...
    <div class="container mx-auto mt-4">
        <h1 class="text-xl font-bold mb-4">Tạo Chủ Đề</h1>

        <!-- Form tạo chủ đề -->
        <form action="{{ route('topic.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="mb-2">
                ...
                <input type="text" id="name" class="w-full border rounded p-2" name="name"
                    value="{{ old('name') }}" placeholder="Nhập tên chủ đề" required>
